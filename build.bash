...
declare -A PROJECTS=(
  [DesperateDevs.Caching]=Runtime
  [DesperateDevs.Extensions]=Runtime
  [DesperateDevs.Reflection]=Runtime
  [DesperateDevs.Serialization]=Runtime
  [DesperateDevs.Threading]=Runtime
  [DesperateDevs.Unity]=Runtime
  [DesperateDevs.Unity.Editor]=Editor
)
  ...
  cat << EOF > "${dist}/package.json"
{
  ...
  "description": "${project}",
  "unity": "2021.3",
  "documentationUrl": "https://github.com/sschmid/DesperateDevs",
  "changelogUrl": "https://github.com/sschmid/DesperateDevs/blob/main/CHANGELOG.md",
  "licensesUrl": "https://github.com/sschmid/DesperateDevs/blob/main/LICENSE.md",
